...
def get_bert_inf(phones, word2ph, norm_text, language):
    ...
    print(23333333,language,norm_text,word2ph)
    if language == "zh":
...
def nonen_get_bert_inf(text, language):
    print("aaaaaaaaaaaaaaaaaaaaaaaaa::::::::::",text,language)
    if(language!="auto"):
        textlist, langlist = splite_en_inf(text, language)
    else:
        textlist=[]
    ...
    for i in range(len(textlist)):
        ...
        print(123444455555,phones,word2ph,norm_text,text,lang)
...
def get_bert_final(phones, word2ph, text,language,device):
    print(1111111111,text,language)
    if language == "en":
...
def get_tts_wav(ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut=i18n("不切")):
    ...
    print(32132133333333,prompt_language,text_language)
    ...
    for text in texts:
        ...
        t4 = ttime()
    t5 = ttime()
    print("%.3f\t%.3f\t%.3f\t%.3f\t%.3f" % (t1 - t0, t2 - t1, t3 - t2, t4 - t3, t5-t0))
